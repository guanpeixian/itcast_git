...
public class HealExcetionAdvice {
     ...
     */
    private static final Logger log = LoggerFactory.getLogger(HealExcetionAdvice.class);
    ...
    public Result handleHealthExcetion(HealthException he){
